...
const techStacks = [
  {
    ...
    icon: Cloud,
    technologies: ['AWS EKS', 'Azure AKS', 'GCP GKE', 'Terraform'],
  ...
  },
  {
    ...
    icon: Brain,
    technologies: ['Pinecone', 'Weaviate', 'LangChain', 'OpenAI'],
  ...
  },
  {
    ...
    icon: GitBranch,
    technologies: ['Jenkins', 'ArgoCD', 'Ansible', 'Kubernetes'],
  ...
  },
  {
    ...
    icon: Code,
    technologies: ['Spring Boot', 'Node.js', 'GraphQL', 'Docker'],
